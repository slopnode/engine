...
const char* VirtualFileSystem::kindDirectory(AssetKind kind) {
    ...
    case AssetKind::MapSource: return "maps";
    case AssetKind::MapCarved: return "maps";
    ...
    case AssetKind::PrefabSource: return "prefabs";
...
const char* VirtualFileSystem::implicitExtension(AssetKind kind) {
    ...
    case AssetKind::PrefabSource: return ".map";
